                                    ...
                                    <div class="card-datatable">
                                        <table class="dt-standard table table-bordered table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <th class="d-sm-table-cell text-center">Harga</th>
                                                <th class="d-sm-table-cell text-center">Stok</th>
                                            ...
                                            @foreach($data as $key => $result)
                                                <tr>
                                                    ...
                                                    <td class="d-sm-table-cell text-center text-truncate">Rp. {{$result->price}}</td>
                                                    <td class="d-sm-table-cell text-center text-truncate">{{$result->stock}} Item</td>
                                                    <td class="d-md-table-cell text-center">
                                                        <img class="dt-img-preview" src="{{asset('storage/images/product/'.$result->image)}}" alt="Gambar Produk">
                                                    </td>
                                                    <td class="d-sm-table-cell text-center">
                                                        <a href="{{route('admin.product.edit',$result->id)}}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Sunting Data">
                                                            <i data-feather="edit-3"></i>
                                                        </a>
                                                        <button id="btn-remove" class="btn btn-sm btn-danger" data-url="{{route('admin.product.delete',$result->id)}}" data-toggle="tooltip" title="Hapus Data">
