    ...
    <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav bookmark-icons">
                <li class="nav-item d-none d-lg-block ">
                    <div class="d-flex align-items-center">
                        <i class="ficon icon-clock" data-feather="clock"></i>
                        <a class="txt-clock pl-1 nav-link" data-toggle="tooltip" data-placement="top" title="" data-original-title="Waktu Saat Ini">
                            <span id="date">Jumat, 23 Juni 2021</span><br>
                            <span id="time">20:15</span>
                        </a>
                    </div>
                </li>
            </ul>
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ auth()->user()->name }}</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{asset('storage/images/avatar/default.png')}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                </a>
