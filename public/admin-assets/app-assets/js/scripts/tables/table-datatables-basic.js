...
$(function () {
  ...
  var dt_basic_table = $('.datatables-basic'),
    ...
    dt_standard_table = $('.dt-standard'),
    dt_export_table = $('.dt-export'),
...
// if (dt_standard_table.length) {
    var dt_standard = dt_standard_table.DataTable({
        dom:
            '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
        displayLength: 10,
...
// if (dt_export_table.length) {
    var dt_export = dt_export_table.DataTable({
        dom:
            '<"card-header border-bottom p-1"<"head-label"><"dt-action-buttons text-right"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
        displayLength: 10,
        lengthMenu: [10, 25, 50, 75, 100],
    ...
    $('div.head-label').html('<h6 class="mb-0">Daftar Data</h6>');
// }
